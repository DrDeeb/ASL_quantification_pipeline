...
my $log_dir     = $root_dir . '/data/siemens_data/preventad/PAD_data_tr32ch/output_PAD_tr32ch/logs/log_ASL_quantif';
my $command_mkdir_log	= "mkdir -p " . $log_dir;
system($command_mkdir_log);
my $out         = $root_dir . '/data/siemens_data/preventad/PAD_data_tr32ch/output_PAD_tr32ch/ASL/ASLquant_v2-094_Elcapitan';
